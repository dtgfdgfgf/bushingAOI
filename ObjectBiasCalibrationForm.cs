    ...
    public partial class ObjectBiasCalibrationForm : Form
    {
        ...
        private void CreateControls()
        {
            ...
            var lblDescription = new Label
            {
                ...
                Size = new System.Drawing.Size(960, 40),
            ...
            {
                Location = new System.Drawing.Point(480, 65),
            ...
            this.Controls.AddRange(new Control[] {
                lblDescription, cmbStation, btnSelectImages, btnAnalyzeControl, progressBarControl,
        ...
        {
            if (centerResults.Count == 0) return;
        ...
        private void BtnApply_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    UpdateParameter(db, $"objBias_{targetStation}_X", recommendedBiasX.ToString());
                    UpdateParameter(db, $"objBias_{targetStation}_Y", recommendedBiasY.ToString());
                }

                MessageBox.Show($"成功套用 objBias 設定！\n" +
                               $"objBias_{targetStation}_X = {recommendedBiasX}\n" +
                               $"objBias_{targetStation}_Y = {recommendedBiasY}",
        ...
        private void UpdateParameter(MydbDB db, string paramName, string value)
        {
            ...
            else
            {
                db.Insert(new Param
                {
                    ...
                    Value = value,
                    Stop = targetStation,
                    ChineseName = paramName.Contains("X") ? "物體X軸偏移補償" : "物體Y軸偏移補償"
                });
            }
        }
