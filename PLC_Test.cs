...
namespace PLC
{
    ...
    public static class PLC_ModBus
    {
        ...
        public static ConcurrentQueue<CommentData> SendData = new ConcurrentQueue<CommentData>();
        public static ConcurrentQueue<CommentData> SendData_Emergency = new ConcurrentQueue<CommentData>();
